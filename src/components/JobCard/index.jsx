...
const JobCard = ({ job }) => {
  ...
  return (
    <Card className="w-100 position-relative border-0 rounded-3 py-4 px-2 transition dark-blue job-card">
      <span
        className="position-absolute top-0 start-0 d-flex align-items-center 
      ...
      <Card.Body className="job-card__body">
        ...
        <Card.Title className="mt-2 transition d-white job-card__position">
          {job.position}
        </Card.Title>
