...
const Home = () => {
  ...
  const filteredJobs = () => {
    ...
    if (title) {
      ...
      jobs = data.filter(
        (item) =>
          item["position"].toLowerCase() === titleLowerCased ||
          item["company"].toLowerCase() === titleLowerCased
      );
    }
      ...
      <Container as="main" fluid className="position-relative">
        ...
        {filteredJobs().length > 0 ? (
          <Container as="section" fluid className="px pb-5 mt-4">
            ...
            <Button
              className="home-button d-block load-more"
          ...
          <Container as="section" fluid className="px error-section">
            ...
            <Button
              className="home-button d-block error__button"
              onClick={tryAgain}
            >
              Try again
            </Button>
